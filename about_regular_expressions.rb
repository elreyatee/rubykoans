...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # Since * will always accept zero or more of a certain character, it won't
    # check for anything preceding the character in the expression i.e.
    # "abc"[/ab*c/] => "abc"
    # "abc"[/az*c/] => nil
  end
  ...
  #
  # Why? They will match as many as possible.
  ...
  # An alternation looks for a specific string while a character class is defining
  # a match based on certain criteria.
