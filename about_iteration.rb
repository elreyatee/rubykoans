...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject is like keeping a ledger. The value in () is the initial value
    # of the ledger total. Inject iterates over each item in the array,
    # performing the operation in the block which updates the ledger.
  end
  ...
  #   # code to read 'file'
  #
  # Because file = File.open(filename) return a file object that you have to call
  # another method to read the lines File#read. 
  #
